...
import { todoCategorySchema, todoContentSchema } from "../schemas/index.js";

const TodoCategory = model("todoCategory", todoCategorySchema);
// const TodoContent = model("todoContent", todoContentSchema);
